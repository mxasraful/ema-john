                            ...
                            <ul className="me-5 navbar-nav">
                                {
                                    path === "/" ?
                                        ...
                                        :
                                        <li class="nav-item">
                                            <Link className={path ===  "/cart" ? "nav-link px-4 text-light bg-dark me-2 active-nav" : "nav-link px-4 text-light bg-dark me-2"} style={{ marginTop: "-3px" }} to="/cart">
                                ...
                                <li className="nav-item">
                                    {
                                        auth.user ?
                                            ...
                                            :
                                            <a className={path ===  "/login" ? "nav-link text-light px-4 active-nav" : "nav-link px-4 text-light"} style={{ cursor: 'pointer' }} href="/login">
                                                <span>Sign In</span>
                                            </a>
                                    }
                                </li>
